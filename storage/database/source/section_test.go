...
func (mockDialect) FetchIDBounds(context.Context) (int64, int64, error)                         { return 0, 0, nil }
func (mockDialect) QueryMapByRange(context.Context, int64, int64) (storage.MapEntries, error)   { return nil, nil }
func (mockDialect) Close() error                                                                { return nil }

func TestSection_Prepare_NegativeMaxItems(t *testing.T) {
	_, err := newSection[storage.MapEntry](nil, mockDialect{}, SectionConfig{
		MaxItems: -1,
		PageSize: 100,
	})
	if err == nil {
