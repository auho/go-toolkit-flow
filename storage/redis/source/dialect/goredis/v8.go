...
func (v *v8) HashScan(ctx context.Context, keyName string, cursor uint64, count int64) (storage.StringMapEntries, uint64, error) {
...
func (v *v8) SortedSetScan(ctx context.Context, keyName string, cursor uint64, count int64) (storage.StringMapEntries, uint64, error) {
...
func (v *v8) parseStringMapEntries(items []string) storage.StringMapEntries {
